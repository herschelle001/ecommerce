...
class PasswordSpaceValidator:
    """
    Validate whether the password has spaces
    """
    ...
    def validate(self, password, user=None):
        ...
        for c in [' ', '\n', '\t', '\r', '%20',]:
            if c in a:
                raise ValidationError(_("Password contains invalid characters like whitespace characters"))
                
    def get_help_text(self):
        return _("Your password contains whitespace characters")